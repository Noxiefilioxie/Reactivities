...
const Counter = observer(function Counter() {
  ...
  return (
    <Box display='flex' justifyContent='space-between'>
      <Box sx={{ width: '60%' }}>
        <Typography variant="h4" gutterBottom> Counter: {counterStore.title} </Typography>
        ...
        <ButtonGroup sx={{ mt: 3 }}>
          ...
          <Button variant="contained" color="primary" onClick={() => counterStore.increment(5)}>Increment by five</Button>
        </ButtonGroup>
      </Box>
      <Box sx={{ width: '40%', p: 4 }}>
